...
copied as text or turned into type on the page. A notebook can be written out as a PDF or copied
somewhere safe, and the application updates itself from its published releases.
